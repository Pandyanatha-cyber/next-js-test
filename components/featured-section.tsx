        ...
        <div className="max-w-7xl mx-auto">
            ...
            >
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    Domain Expansion is the most supreme technique of any 
                    jujutsu user. It is achieved by expanding one's innate 
                    domain with cursed energy while using a barrier to 
                    construct it inside a separate space. 
                </p>
            </motion.div>
            <div className="grid md:grid-cols-2 gap-8">
                {posts.map((post, index) => (
                    ...
                    >
                        ...
                        <Card className="group cursor-pointer overflow-hidden hover:shadow-xl
